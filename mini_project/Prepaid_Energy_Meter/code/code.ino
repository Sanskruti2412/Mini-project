...
String phone_no1 = "+919422291281"; //Enter Consumer number
String phone_no2 = "+918624886963"; //Enter Company number
...
Serial.println("Welcome to energy meter");
...
void loop(){
//If a character comes in from the cGSM module
  if(GSM.available() >0){
  inchar=GSM.read(); 
  if(inchar=='R'){
  delay(10);
  ...
  inchar=GSM.read();
      ...
      sendSMS(phone_no1,"Your Recharge is Updated: 100");  
      sendSMS(phone_no2,"Your Recharge is Updated: 100"); 
      load_on();
      }
 else if(inchar=='2'){price = 200 / Set;  total_unt = total_unt +price; 
      sendSMS(phone_no1,"Your Recharge is Updated: 200");  
      sendSMS(phone_no2,"Your Recharge is Updated: 200");
      load_on();
 }
 else if(inchar=='3'){price = 300 / Set;  total_unt = total_unt +price;
      sendSMS(phone_no1,"Your Recharge is Updated: 300");  
      sendSMS(phone_no2,"Your Recharge is Updated: 300");
      load_on();
 }
 else if(inchar=='4'){price = 400 / Set;  total_unt = total_unt +price;
      sendSMS(phone_no1,"Your Recharge is Updated: 400");  
      sendSMS(phone_no2,"Your Recharge is Updated: 400"); 
      load_on();
 }
      delay(10);
      }
...
void ai5() {// ai0 is activated if DigitalPin nr 2 is going from LOW to HIGH
